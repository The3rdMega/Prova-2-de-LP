...
instance Print AbsLI.ClassDeclaration where
  prt i e = case e of
    AbsLI.ClassD id extends memberdeclarations -> prPrec i 0 (concatD [doc (showString "class"), prt 0 id, prt 0 extends, doc (showString "{"), prt 0 memberdeclarations, doc (showString "}")])
  prtList _ [] = concatD []
  prtList _ (x:xs) = concatD [prt 0 x, prt 0 xs]

instance Print AbsLI.Extends where
  prt i e = case e of
    AbsLI.ExtId id -> prPrec i 0 (concatD [doc (showString "extends"), prt 0 id])
    AbsLI.ExtObject -> prPrec i 0 (concatD [])
